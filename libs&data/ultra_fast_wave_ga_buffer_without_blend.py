"""
Ultra-Fast WaveGA with Numba JIT Compilation - BUFFER, NO BLENDING VERSION
Uses buffer for temporal diversity but only OVERALL fitness (multiclass balanced accuracy).
No blended fitness - simpler optimization landscape.
...
# =====================================================================
# MAIN ULTRA-FAST WAVEGA WITH BUFFER CLASS
# =====================================================================

class UltraFastWaveGAWithBuffer:
    """
    Ultra-optimized WaveGA with Numba JIT compilation - BUFFER, NO BLENDING VERSION.
    Uses circular buffer for temporal diversity but only OVERALL fitness.
    ...
    def _build_wave_batch(self, target_class, classes, n_samples=250):
        """Fast wave batch construction from buffer."""
    ...
    def partial_fit(self, X, y):
        """Ultra-fast incremental update with buffer."""
        ...
        # Update best weights using overall fitness
